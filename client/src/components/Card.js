  ...
  return (
      <article className='card'>
        <header className='card__header'>
          ...
          <img  className='card__header-img' src='https://1.bp.blogspot.com/-Jwa4A-wYfLg/X7vfbnU8Z7I/AAAAAAAAL3Q/0exfonfQzQUrZPF9yAN5o-bqURbuaj7uQCLcBGAsYHQ/s1000/SE-21.PNG' alt='stamp'/>
        </header>
        <main className='card__body'>
          <p>{postCard.message}</p>
        </main>
        <footer className='card__footer'>
          <button className='card__delete-btn' onClick={handleDelete}>Delete</button>
